...
export const BLING_DEPOT_ITEMS = [
  ...
  },
  {
    ...
    icon: "🦇",
    mood: "Dramatic",
    vibe: "Emo moonlight poet who cries in aesthetic lighting",
    accessories: ["Eyeliner wing", "Tiny chain choker"],
    animation: "Wink Loop",
  ...
  },
  {
    ...
    icon: "🐰",
    mood: "Flirty",
    vibe: "Vacation main character energy, always",
    accessories: ["Heart sunglasses", "Flip flops"],
  ...
  },
  {
    ...
    icon: "🦊",
    mood: "Chaotic",
    vibe: "Neon notification goblin who never logs off",
    accessories: ["Headphones", "Pixel tail"],
    animation: "Sparkle Bounce",
    reactions: ["Fire", "Laugh", "Icon"],
  },
  {
    ...
    icon: "🦝",
    mood: "Chaotic",
    vibe: "Hoodie trash panda royalty",
    accessories: ["Oversized hoodie", "Glitter trash bag"],
  ...
  },
  {
    ...
    icon: "🐱",
    mood: "Fancy",
    vibe: "Judgmental glam icon in platform boots",
    accessories: ["Heart glasses", "Platform boots"],
  ...
  },
  {
    ...
    icon: "👿",
    mood: "Chaotic",
    vibe: "Loyal little menace with questionable advice",
    accessories: ["Tiny horns", "Wobbly wings"],
    animation: "Chaos Wiggle",
    reactions: ["Fire", "Laugh", "Need One"],
  },
  {
    ...
    icon: "🦙",
    mood: "Dramatic",
    vibe: "Zero-chill main character, everything is a whole situation",
    accessories: ["Dramatic scarf", "Practiced side-eye"],
    animation: "Wink Loop",
    reactions: ["Laugh", "Icon", "Fire"],
  },
  {
    ...
    icon: "🦎",
    mood: "Sleepy",
    vibe: "Quietly glowing judge of your life choices",
    accessories: ["Neon gills", "Tiny crown"],
    animation: "Glow Pulse",
    reactions: ["Sparkle", "Love", "Icon"],
  },
  {
    id: "punk-panda-buddy",
    ...
    icon: "🐼",
    mood: "Bratty",
    vibe: "Soft-hearted anarchist with a bamboo pin",
    accessories: ["Mohawk", "Bamboo pin"],
    animation: "Chaos Wiggle",
    reactions: ["Fire", "Laugh", "Need One"],
  },
  {
    ...
    icon: "🦋",
    mood: "Sleepy",
    vibe: "Moonlight-chasing dreamy wanderer",
    accessories: ["Dust wings", "Star freckles"],
    animation: "Floating Sass",
  ...
  },
  {
    ...
    icon: "🦆",
    mood: "Flirty",
    vibe: "Never-stopped-dancing disco icon since 1978",
    accessories: ["Disco collar", "Tiny platforms"],
    animation: "Sparkle Bounce",
    reactions: ["Laugh", "Fire", "Icon"],
  },
  {
    ...
    icon: "🐉",
    mood: "Fancy",
    vibe: "Gem-hoarding tiny royalty",
    accessories: ["Gem scales", "Tiny hoard"],
    animation: "Glow Pulse",
    reactions: ["Sparkle", "Icon", "Love"],
  },
  {
